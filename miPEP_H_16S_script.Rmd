...
tree <- read.tree(here("data", "16S", "tree.fasttree"))
tree
...
#Anovas
#Root
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="RACINE" & phylum.long$Phylum=="Acidobacteria"),])) #NS
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="RACINE" & phylum.long$Phylum=="Actinobacteria"),])) #NS
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="RACINE" & phylum.long$Phylum=="Bacteroidetes"),])) #NS
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="RACINE" & phylum.long$Phylum=="Chloroflexi"),])) #NS
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="RACINE" & phylum.long$Phylum=="Cyanobacteria"),])) #NS
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="RACINE" & phylum.long$Phylum=="FCPU426"),])) #NS
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="RACINE" & phylum.long$Phylum=="Gemmatimonadetes"),])) #NS
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="RACINE" & phylum.long$Phylum=="Planctomycetes"),])) #40.78 3.64e-10 ***
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="RACINE" & phylum.long$Phylum=="Proteobacteria"),])) #8.91 0.000287 ***
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="RACINE" & phylum.long$Phylum=="Verrucomicrobia"),])) #NS

#Unplanted
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="SOL.NU" & phylum.long$Phylum=="Acidobacteria"),])) #NS
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="SOL.NU" & phylum.long$Phylum=="Actinobacteria"),])) #3.991 0.0174*
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="SOL.NU" & phylum.long$Phylum=="Bacteroidetes"),])) #6.739 0.0145**
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="SOL.NU" & phylum.long$Phylum=="Chloroflexi"),])) #16.86 1.88e-06***
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="SOL.NU" & phylum.long$Phylum=="Cyanobacteria"),])) #4.118 0.0154*
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="SOL.NU" & phylum.long$Phylum=="FCPU426"),])) #11.87 3.41e-05***
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="SOL.NU" & phylum.long$Phylum=="Gemmatimonadetes"),])) #NS
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="SOL.NU" & phylum.long$Phylum=="Planctomycetes"),])) #8.296 0.000419 ***
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="SOL.NU" & phylum.long$Phylum=="Proteobacteria"),])) #NS
summary(aov(relabund~Type, data = phylum.long[(phylum.long$Compartment=="SOL.NU" & phylum.long$Phylum=="Verrucomicrobia"),])) #3.313 0.0343*
```
...
Fig2 <- ggarrange(StackedBarPlot_phylum_rel_EY,p_Div,bact.qPCR.box, ncol = 1, legend = "bottom", labels = c("A","B","C"))
Fig2
