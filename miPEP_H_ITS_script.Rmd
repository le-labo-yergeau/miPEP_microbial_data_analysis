...
biom_file<-import_biom("~/metabarcoding_miPEP_mutants/ITS/ITS/plaque2/export/otu_tables/otu_table_filtered.biom", "~/metabarcoding_miPEP_mutants/ITS/ITS/plaque2/export/tree/tree.fasttree", "~/metabarcoding_miPEP_mutants/ITS/ITS/plaque2/export/otu_tables/otus.fasta", parseFunction=parse_taxonomy_greengenes)
biom_file
```
...
```{r}
sample<- data.frame(fread("~/metabarcoding_miPEP_mutants/ITS/ITS/plaque2/export/mapping_file.tsv", sep="\t"), check.names=F)
head(sample)
...
```{r}
otu_biom <- import_biom("~/metabarcoding_miPEP_mutants/ITS/ITS/plaque2/otu_table_absolute_ITS.biom1")
