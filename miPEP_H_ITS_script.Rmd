...
Fig4 <- ggarrange(StackedBarPlot_phylum_rel_EY,p_Div,fun.qPCR.box, ncol = 1, legend = "bottom", labels = c("A","B","C"))
Fig4
ggsave(filename = here("output", "Fig4.tiff"),  plot = Fig4, compression = "lzw", height = 14, units = "in")
