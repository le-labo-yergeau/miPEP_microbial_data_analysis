...
alpha = 0.001
sigtab_roots_miPEPa = res_roots_miPEPa_order[which(res_roots_miPEPa_order$padj < alpha),]
sigtab_roots_miPEPa_top_47 <- sigtab_roots_miPEPa[c(1:47),] # select the 47 ASV with lowest p-adj
sigtab_roots_miPEPa_top_47 = cbind(as(sigtab_roots_miPEPa_top_47, "data.frame"), as(tax_table(phylo_roots)[rownames(sigtab_roots_miPEPa_top_47), ], "matrix"))
dim(sigtab_roots_miPEPa_top_47)
...
# Phylum order
x = tapply(sigtab_roots_miPEPa_top_47$log2FoldChange, sigtab_roots_miPEPa_top_47$Phylum, function(x) max(x))
x = sort(x, TRUE)
sigtab_roots_miPEPa_top_47$Phylum = factor(as.character(sigtab_roots_miPEPa_top_47$Phylum), levels=names(x))
# Genus order
x = tapply(sigtab_roots_miPEPa_top_47$log2FoldChange, sigtab_roots_miPEPa_top_47$Genus, function(x) max(x))
x = sort(x, TRUE)
sigtab_roots_miPEPa_top_47$Genus = factor(as.character(sigtab_roots_miPEPa_top_47$Genus), levels=names(x))
plot_miPEPa_roots <- ggplot(sigtab_roots_miPEPa_top_47, aes(x=Genus, y=log2FoldChange, color=Phylum)) + geom_point(size=1) +theme(axis.text.x = element_text(size=8, angle = -90, hjust = 0, vjust=0.5), legend.text = element_text(size = 10))+ geom_hline(yintercept=0, color="black") + labs(title = "Top 47 differentially abundant ASVs in comparison with control (p-adj<0.001)",subtitle = "MiPEP-A in roots and close rhizosphere")
plot_miPEPa_roots
...
alpha = 0.001
sigtab_roots_miPEPb = res_roots_miPEPb_order[which(res_roots_miPEPb_order$padj < alpha),]
sigtab_roots_miPEPb_top_45 <- sigtab_roots_miPEPb[c(1:45),] # select the 45 ASV with lowest p-adj
sigtab_roots_miPEPb_top_45 = cbind(as(sigtab_roots_miPEPb_top_45, "data.frame"), as(tax_table(phylo_roots)[rownames(sigtab_roots_miPEPb_top_45), ], "matrix"))
dim(sigtab_roots_miPEPb_top_45)
...
# Phylum order
x = tapply(sigtab_roots_miPEPb_top_45$log2FoldChange, sigtab_roots_miPEPb_top_45$Phylum, function(x) max(x))
x = sort(x, TRUE)
sigtab_roots_miPEPb_top_45$Phylum = factor(as.character(sigtab_roots_miPEPb_top_45$Phylum), levels=names(x))
# Genus order
x = tapply(sigtab_roots_miPEPb_top_45$log2FoldChange, sigtab_roots_miPEPb_top_45$Genus, function(x) max(x))
x = sort(x, TRUE)
sigtab_roots_miPEPb_top_45$Genus = factor(as.character(sigtab_roots_miPEPb_top_45$Genus), levels=names(x))
plot_miPEPb_roots <- ggplot(sigtab_roots_miPEPb_top_45, aes(x=Genus, y=log2FoldChange, color=Phylum)) + geom_point(size=1) +theme(axis.text.x = element_text(size=8, angle = -90, hjust = 0, vjust=0.5), legend.text = element_text(size = 10))+ geom_hline(yintercept=0, color="black") + labs(title = "Top 45 differentially abundant ASVs in comparison with control (p-adj<0.001)",subtitle = "MiPEP-B in roots and close rhizosphere")
plot_miPEPb_roots
...
alpha = 0.001
sigtab_roots_miPEPc = res_roots_miPEPc_order[which(res_roots_miPEPc_order$padj < alpha),]
...
alpha = 0.001
sigtab_soil_miPEPa = res_soil_miPEPa_order[which(res_soil_miPEPa_order$padj < alpha),]
...
alpha = 0.001
sigtab_soil_miPEPb = res_soil_miPEPb_order[which(res_soil_miPEPb_order$padj < alpha),]
sigtab_soil_miPEPb_top_39 <- sigtab_soil_miPEPb[c(1:39),] # select the 39 ASV with lowest p-adj
sigtab_soil_miPEPb_top_39 = cbind(as(sigtab_soil_miPEPb_top_39, "data.frame"), as(tax_table(phylo_soil)[rownames(sigtab_soil_miPEPb_top_39), ], "matrix"))
dim(sigtab_soil_miPEPb_top_39)
...
# Phylum order
x = tapply(sigtab_soil_miPEPb_top_39$log2FoldChange, sigtab_soil_miPEPb_top_39$Phylum, function(x) max(x))
x = sort(x, TRUE)
sigtab_soil_miPEPb_top_39$Phylum = factor(as.character(sigtab_soil_miPEPb_top_39$Phylum), levels=names(x))
# Genus order
x = tapply(sigtab_soil_miPEPb_top_39$log2FoldChange, sigtab_soil_miPEPb_top_39$Genus, function(x) max(x))
x = sort(x, TRUE)
sigtab_soil_miPEPb_top_39$Genus = factor(as.character(sigtab_soil_miPEPb_top_39$Genus), levels=names(x))
plot_miPEPb_soil <- ggplot(sigtab_soil_miPEPb_top_39, aes(x=Genus, y=log2FoldChange, color=Phylum)) + geom_point(size=1) +theme(axis.text.x = element_text(size=8, angle = -90, hjust = 0, vjust=0.5), legend.text = element_text(size = 10))+ geom_hline(yintercept=0, color="black") + labs(title = "Top 39 differentially abundant ASVs in comparison with control (p-adj<0.001)",subtitle = "MiPEP-B in distant rhizosphere")
plot_miPEPb_soil
...
alpha = 0.001
sigtab_soil_miPEPc = res_soil_miPEPc_order[which(res_soil_miPEPc_order$padj < alpha),]
sigtab_soil_miPEPc_top_45 <- sigtab_soil_miPEPc[c(1:45),] # select the 45 ASV with lowest p-adj
sigtab_soil_miPEPc_top_45 = cbind(as(sigtab_soil_miPEPc_top_45, "data.frame"), as(tax_table(phylo_soil)[rownames(sigtab_soil_miPEPc_top_45), ], "matrix"))
dim(sigtab_soil_miPEPc_top_45)
...
# Phylum order
x = tapply(sigtab_soil_miPEPc_top_45$log2FoldChange, sigtab_soil_miPEPc_top_45$Phylum, function(x) max(x))
x = sort(x, TRUE)
sigtab_soil_miPEPc_top_45$Phylum = factor(as.character(sigtab_soil_miPEPc_top_45$Phylum), levels=names(x))
# Genus order
x = tapply(sigtab_soil_miPEPc_top_45$log2FoldChange, sigtab_soil_miPEPc_top_45$Genus, function(x) max(x))
x = sort(x, TRUE)
sigtab_soil_miPEPc_top_45$Genus = factor(as.character(sigtab_soil_miPEPc_top_45$Genus), levels=names(x))
plot_miPEPc_soil <- ggplot(sigtab_soil_miPEPc_top_45, aes(x=Genus, y=log2FoldChange, color=Phylum)) + geom_point(size=1) +theme(axis.text.x = element_text(size=8, angle = -90, hjust = 0, vjust=0.5), legend.text = element_text(size = 10))+ geom_hline(yintercept=0, color="black") + labs(title = "Top 45 differentially abundant ASVs in comparison with control (p-adj<0.001)",subtitle = "MiPEP-C in distant rhizosphere")
plot_miPEPc_soil
```
...
alpha = 0.001
sigtab_unplanted_miPEPa = res_unplanted_miPEPa_order[which(res_unplanted_miPEPa_order$padj < alpha),]
sigtab_unplanted_miPEPa_top_43 <- sigtab_unplanted_miPEPa[c(1:43),] # select the 43 ASV with lowest p-adj
sigtab_unplanted_miPEPa_top_43 = cbind(as(sigtab_unplanted_miPEPa_top_43, "data.frame"), as(tax_table(phylo_unplanted)[rownames(sigtab_unplanted_miPEPa_top_43), ], "matrix"))
dim(sigtab_unplanted_miPEPa_top_43)
...
# Phylum order
x = tapply(sigtab_unplanted_miPEPa_top_43$log2FoldChange, sigtab_unplanted_miPEPa_top_43$Phylum, function(x) max(x))
x = sort(x, TRUE)
sigtab_unplanted_miPEPa_top_43$Phylum = factor(as.character(sigtab_unplanted_miPEPa_top_43$Phylum), levels=names(x))
# Genus order
x = tapply(sigtab_unplanted_miPEPa_top_43$log2FoldChange, sigtab_unplanted_miPEPa_top_43$Genus, function(x) max(x))
x = sort(x, TRUE)
sigtab_unplanted_miPEPa_top_43$Genus = factor(as.character(sigtab_unplanted_miPEPa_top_43$Genus), levels=names(x))
plot_miPEPa_unplanted <- ggplot(sigtab_unplanted_miPEPa_top_43, aes(x=Genus, y=log2FoldChange, color=Phylum)) + geom_point(size=1) +theme(axis.text.x = element_text(size=8, angle = -90, hjust = 0, vjust=0.5), legend.text = element_text(size = 10))+ geom_hline(yintercept=0, color="black") + labs(title = "Top 43 differentially abundant ASVs in comparison with control (p-adj<0.001)",subtitle = "MiPEP-A in unplanted soils")
plot_miPEPa_unplanted
...
alpha = 0.001
sigtab_unplanted_miPEPb = res_unplanted_miPEPb_order[which(res_unplanted_miPEPb_order$padj < alpha),]
sigtab_unplanted_miPEPb_top_48 <- sigtab_unplanted_miPEPb[c(1:48),] # select the 48 ASV with lowest p-adj
sigtab_unplanted_miPEPb_top_48 = cbind(as(sigtab_unplanted_miPEPb_top_48, "data.frame"), as(tax_table(phylo_unplanted)[rownames(sigtab_unplanted_miPEPb_top_48), ], "matrix"))
dim(sigtab_unplanted_miPEPb_top_48)
...
# Phylum order
x = tapply(sigtab_unplanted_miPEPb_top_48$log2FoldChange, sigtab_unplanted_miPEPb_top_48$Phylum, function(x) max(x))
x = sort(x, TRUE)
sigtab_unplanted_miPEPb_top_48$Phylum = factor(as.character(sigtab_unplanted_miPEPb_top_48$Phylum), levels=names(x))
# Genus order
x = tapply(sigtab_unplanted_miPEPb_top_48$log2FoldChange, sigtab_unplanted_miPEPb_top_48$Genus, function(x) max(x))
x = sort(x, TRUE)
sigtab_unplanted_miPEPb_top_48$Genus = factor(as.character(sigtab_unplanted_miPEPb_top_48$Genus), levels=names(x))
plot_miPEPb_unplanted <- ggplot(sigtab_unplanted_miPEPb_top_48, aes(x=Genus, y=log2FoldChange, color=Phylum)) + geom_point(size=1) +theme(axis.text.x = element_text(size=8, angle = -90, hjust = 0, vjust=0.5), legend.text = element_text(size = 10))+ geom_hline(yintercept=0, color="black") + labs(title = "Top 48 differentially abundant ASVs in comparison with control (p-adj<0.001)",subtitle = "MiPEP-B in unplanted soils")
...
alpha = 0.001
sigtab_unplanted_miPEPc = res_unplanted_miPEPc_order[which(res_unplanted_miPEPc_order$padj < alpha),]
sigtab_unplanted_miPEPc_top_39 <- sigtab_unplanted_miPEPc[c(1:39),] # select the 39 ASV with lowest p-adj
sigtab_unplanted_miPEPc_top_39 = cbind(as(sigtab_unplanted_miPEPc_top_39, "data.frame"), as(tax_table(phylo_unplanted)[rownames(sigtab_unplanted_miPEPc_top_39), ], "matrix"))
dim(sigtab_unplanted_miPEPc_top_39)
...
# Phylum order
x = tapply(sigtab_unplanted_miPEPc_top_39$log2FoldChange, sigtab_unplanted_miPEPc_top_39$Phylum, function(x) max(x))
x = sort(x, TRUE)
sigtab_unplanted_miPEPc_top_39$Phylum = factor(as.character(sigtab_unplanted_miPEPc_top_39$Phylum), levels=names(x))
# Genus order
x = tapply(sigtab_unplanted_miPEPc_top_39$log2FoldChange, sigtab_unplanted_miPEPc_top_39$Genus, function(x) max(x))
x = sort(x, TRUE)
sigtab_unplanted_miPEPc_top_39$Genus = factor(as.character(sigtab_unplanted_miPEPc_top_39$Genus), levels=names(x))
plot_miPEPc_unplanted <- ggplot(sigtab_unplanted_miPEPc_top_39, aes(x=Genus, y=log2FoldChange, color=Phylum)) + geom_point(size=1) +theme(axis.text.x = element_text(size=8, angle = -90, hjust = 0, vjust=0.5), legend.text = element_text(size = 10))+ geom_hline(yintercept=0, color="black") + labs(title = "Top 39 differentially abundant ASVs in comparison with control (p-adj<0.001)",subtitle = "MiPEP-C in unplanted soils")
